...
async def main() -> None:
    ...
    with Flowcept(
        workflow_name="academy_perceptron_gridsearch_dynamic_runtime_instrumentation_driver",
        ...
        with log_context(log_config):
            logger.info("start academy perceptron gridsearch dynamic runtime instrumentation")
            processes = {}
            ...
            logger.info("end academy perceptron gridsearch dynamic runtime instrumentation")
