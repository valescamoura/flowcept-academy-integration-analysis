...
def start_agent_process(role: str, registration, *extra_args: str):
    command = [
        sys.executable,
        "run_agent.py",
        "--role",
...
async def main() -> None:
    ...
    with Flowcept(
        ...
        workflow_name="academy_perceptron_gridsearch_message_stream_observability",
        workflow_subtype="academy_perceptron_gridsearch",
        workflow_args={
            "approach": "message_stream_observability",
            "use_case": "perceptron_gridsearch",
        },
        check_safe_stops=False,
    ):
        with log_context(log_config):
            logger.info("start academy perceptron gridsearch message stream observability")
            processes = {}
            ...
            logger.info("end academy perceptron gridsearch message stream observability")
